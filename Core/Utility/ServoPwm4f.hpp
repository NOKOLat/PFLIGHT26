...
struct ServoPwm4f {
    ...
    float& aileron()  { return data[static_cast<uint8_t>(ServoIndex::AILERON)]; }
    ...
    float aileron()  const { return data[static_cast<uint8_t>(ServoIndex::AILERON)]; }
